package com.anwar.weatherforcastmvvm.features.showinfo.view
...
import com.anwar.weatherforcastmvvm.R
import com.anwar.weatherforcastmvvm.features.showinfo.model.WeatherInfoShowModel
import com.anwar.weatherforcastmvvm.features.showinfo.model.WeatherInfoShowModelImpl
...
import com.anwar.weatherforcastmvvm.features.showinfo.viewmodel.WeatherInfoViewModel
import com.anwar.weatherforcastmvvm.utils.convertToListOfCityName
import com.bumptech.glide.Glide
import kotlinx.android.synthetic.main.activity_main.*
import kotlinx.android.synthetic.main.layout_input_location.*
...
class MainActivity : AppCompatActivity() {
    ...
    private fun LoadData(location: Location?) {
        viewModel!!.getWeathergpsInfo(location!!.latitude, location!!.longitude,model)
    }
    ...
    private fun setViewgpsClickListener() {

        btn_view_gps_weather.setOnClickListener {
            val location = currentLocation
            if (location != null) {
                LoadData(location)
            }
...
//        viewModel.getWeatherInfo(1185241, model)
        ...
        btn_view_weather.setOnClickListener {
            ...
            Log.e("cityyyyyyyyyyyyy", selectedCityId.toString())
    ...
    private fun setWeatherInfo(weatherData: WeatherData) {
        ...
        tv_feelslike_value?.text = weatherData.feelslike
        tv_windspeed_value?.text = weatherData.windspeed
        tv_winddeg_value?.text = weatherData.winddeg
